...
- [x] 랜딩 페이지로 지금까지 저장한 탭을 관리하고, 이동할 수 있어야한다.
  - [ ] 랜딩 페이지 디자인은 frontend-design 플러그인을 활용한다.
  - [ ] 랜딩 페이지는 사이드바앱으로 확인할 수 있게 한다.
  - [ ] 페이지 내에서 검색을 할 수 있게 한다.
  - [ ] 페이지 내에서 다른 세션과 병합 할 수 있게 해줘야 한다.
...
- **sidebar**: 랜딩 페이지를 Whale 사이드바 앱으로 제공
...
- `whale.sidebarAction` — 사이드바 앱 등록 (Whale 전용)
- Manifest V3
